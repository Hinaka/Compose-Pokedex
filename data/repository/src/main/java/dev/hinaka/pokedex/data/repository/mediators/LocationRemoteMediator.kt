...
//    }
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val networkLocations = networkDataSource.getLocations(
                offset = loadKey ?: 0,
            ...
            db.withTransaction {
                ...
                locationDao.insertAll(networkLocations.toEntity())
            }

            MediatorResult.Success(endOfPaginationReached = networkLocations.isEmpty())
        } catch (e: Exception) {
